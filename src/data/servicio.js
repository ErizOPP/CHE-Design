export const getServicios = async ({ filterBy } = {}) => [
    {
    ...
    {
        title: 'Publicidad',
        cover: "https://images-na.ssl-images-amazon.com/images/S/compressed.photo.goodreads.com/books/1347470803i/10284614.jpg",
        description: '"The Clean Coder: Un Código de Conducta para Programadores Profesionales" es un libro excepcional que ',
        href: 'servicios/publicidad'
    },
    {
        title: 'Flyers y Banners',
        cover: 'https://images-na.ssl-images-amazon.com/images/S/compressed.photo.goodreads.com/books/1328834793i/2998152.jpg',
        description: '"JavaScript: The Good Parts" es un libro imprescindible que destaca las mejores prácticas y caracter',
        href: 'servicios/flyers-banners'
    },
    {
        title: 'Ilustración',
